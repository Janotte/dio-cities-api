...
(
	...
	name_pt character varying(60) COLLATE pg_catalog."default",
...
COMMENT ON TABLE country IS 'Countries and Nations';

COMMENT ON COLUMN country.code IS 'ISO 3166-1 Alpha2';
...
--
-- Inserting data into the table "country"
--

INSERT INTO "country" (id, name, name_pt, code, bacen) VALUES
